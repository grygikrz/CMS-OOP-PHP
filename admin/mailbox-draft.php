...
$mails = $comm->pobierzContent('messages', 'WHERE type="draft" ORDER BY date DESC');
?>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="mailbox-draft"><i class="fa fa-file-text-o"></i> Robocze<span class="label label-primary pull-right"><?php echo $comm->countStatistic('messages', 'WHERE type="draft"') ?></span></a></li>
