...
$mails = $comm->pobierzContent('messages', 'WHERE type="junk" ORDER BY date DESC');
?>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="mailbox.php"><i class="fa fa-inbox"></i> Odbiorcza <span class="label label-warning pull-right"><?php echo $comm->countStatistic('messages', 'WHERE type=""') ?></span></a></li>
