...
$mails = $comm->pobierzContent('messages', 'WHERE type="sent" ORDER BY date DESC');
$count = $db->num_rows($mails);
?>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="mailbox-sent.php"><i class="fa fa-envelope-o"></i> Wysłane <span class="label label-success pull-right"><?php echo $comm->countStatistic('messages', 'WHERE type="sent"') ?></span></a></li>
